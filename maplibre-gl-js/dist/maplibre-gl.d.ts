...
declare class LineBucket implements Bucket {
  ...
  */
  ...
  addHalfVertex({
    x,
    y
  }: Point$1, extrudeX: number, extrudeY: number, round: boolean, up: boolean, dir: number, segment: Segment): void;
...
declare class InViewTiles {
  ...
  setFeatureState(featuresChanged: LayerFeatureStates, painter: Painter): void;
  getAllTiles(): Tile[];
...
*/
declare class GeoJSONSource extends Evented implements Source {
  type: "geojson";
  id: string;
  minzoom: number;
  maxzoom: number;
  ...
  * @internal
  */
  shouldReloadTile(tile: Tile, {
    affectedBounds
  }: GeoJSONSourceShouldReloadTileOptions): boolean;
  loaded(): boolean;
...
*/
declare class VectorTileSource extends Evented implements Source {
  type: "vector";
  id: string;
  minzoom: number;
  maxzoom: number;
...
* ```
*/
declare class ImageSource extends Evented implements Source {
  type: string;
  id: string;
  minzoom: number;
  maxzoom: number;
...
interface ITransformMutators {
  ...
  */
  setLocationAtPoint(lnglat: LngLat, point: Point$1): void;
  /**
...
//#endregion
//#region src/ui/handler/gravite.d.ts
/**
* Interface de configuration pour ajuster la physique
*/
type GravityConfig = {
  type_ville: {
    [key: string]: number;
...
declare class ScrollZoomHandler implements Handler {
  ...
  * ```
  */
  enable(options?: ScrollZoomOptions): void;
  /**
...
* ```
*/
declare class Marker extends Evented {
  _map: Map$1;
...
* ```
*/
declare class GeolocateControl extends Evented implements IControl {
  _map: Map$1;
...
*/
declare class FullscreenControl extends Evented implements IControl {
  _map: Map$1;
  _controlContainer: HTMLElement;
  _fullscreen: boolean;
...
*/
declare class RasterTileSource extends Evented implements Source {
...
//#endregion
export { AJAXError, type Actor, type ActorMessage, type AddLayerObject, type AddProtocolAction, type Alignment, type AlphaImage, type AnimationOptions, type AroundCenterOptions, AttributionControl, type AttributionControlOptions, type BoxZoomEndHandler, BoxZoomHandler, type BoxZoomHandlerOptions, type Bucket, type CalculateTileZoomFunction, type CameraForBoundsOptions, type CameraOptions, type CameraUpdateTransformFunction, type CanonicalTileRange, CanvasSource, type CanvasSourceSpecification, type CenterZoomBearing, type CollisionBoxArray, type Complete, type ControlPosition, CooperativeGesturesHandler, type Coordinates, type CoveringTilesOptions, type CreateTileMeshOptions, type CustomLayerInterface, type CustomLayerProjectionDataParams, type CustomRenderMethod, type CustomRenderMethodInput, type DashEntry, type Dispatcher, type DistributiveKeys, type DistributiveOmit, DoubleClickZoomHandler, DragPanHandler, type DragPanOptions, DragRotateHandler, EXTENT, type EaseToOptions, EdgeInsets, type ErrorEvent$1 as ErrorEvent, Event$1 as Event, Evented, type ExpiryData, type FeatureIdentifier, type FeatureIndex, type FitBoundsOptions, type FlyToOptions, FullscreenControl, type FullscreenControlOptions, GPUInitializationError, type GeoJSONFeature, type GeoJSONFeatureDiff, type GeoJSONFeatureId, GeoJSONSource, type GeoJSONSourceDiff, GeolocateControl, type GeolocateControlOptions, type GestureOptions, type GetResourceResponse, GlobeControl, type GlyphPosition, type GlyphPositions, type Handler, type HandlerResult, Hash, type IActor, type IControl, type ImageAtlas, ImageSource, type IndicesType, type JumpToOptions, KeyboardHandler, type Listener, LngLat, LngLatBounds, type LngLatBoundsLike, type LngLatLike, LoadTileResult, LogoControl, type LogoControlOptions, Map$1 as Map, Map$1 as MapLibreMap, type MapContextEvent, type MapDataEvent, type MapEventType, type MapGeoJSONFeature, type MapLayerEventType, type MapLayerMouseEvent, type MapLayerTouchEvent, type MapLibreEvent, type MapLibreZoomEvent, MapMouseEvent, type MapOptions, type MapProjectionEvent, type MapSourceDataEvent, type MapSourceDataType, type MapStyleDataEvent, type MapStyleImageMissingEvent, type MapTerrainEvent, MapTouchEvent, MapWheelEvent, Marker, type MarkerOptions, MercatorCoordinate, type MessageType, NavigationControl, type NavigationControlOptions, type Offset, type OverscaledTileID, type PaddingOptions, type PaintPropertyEntry, type Painter, Point, type PointLike, Popup, type PopupOptions, type PositionAnchor, type ProjectionData, type ProjectionDataParams, type QueryRenderedFeaturesOptions, type QuerySourceFeatureOptions, RasterDEMTileSource, RasterTileSource, type RequestParameters, type RequestResponseMessageMap, type RequestTransformFunction, type RequireAtLeastOne, type ResourceType, ScaleControl, type ScaleControlOptions, ScrollZoomHandler, type SetClusterOptions, type Source, type SourceClass, Style, type StyleGlyph, type StyleImage, type StyleImageData, type StyleImageInterface, type StyleImageMetadata, type StyleLayer, type StyleOptions, type StyleSetterOptions, type StyleSwapOptions, type Subscription, TerrainControl, type TextFit, type Tile, type TileMesh, type TransformConstrainFunction, type TransformStyleFunction, TwoFingersTouchPitchHandler, TwoFingersTouchRotateHandler, TwoFingersTouchZoomHandler, TwoFingersTouchZoomRotateHandler, type Unit, type UnwrappedTileIDLiteral, type UpdateImageOptions, VectorTileSource, VideoSource, type WebGLContextAttributesWithType, type WorkerGlobalScopeInterface, type WorkerTileResult, addProtocol, addSourceType, clearPrewarmedResources, config, createTileMesh, getGlobalDispatcher, getMaxParallelImageRequests, getRTLTextPluginStatus, getVersion, getWorkerCount, getWorkerUrl, importScriptInWorkers, isTimeFrozen, now, prewarm, removeProtocol, restoreNow, setMaxParallelImageRequests, setNow, setRTLTextPlugin, setWorkerCount, setWorkerUrl };